...
$(document).ready(function () {
    ...
    $("#btnReserva").click(function () {
        ...
        alert("Estimado " + nombre + ", agradecemos por reservar con nosotros. Hemos registrado " +
            asistentes + " asistentes. Se ha enviado el código de confirmación al correo " + correo +
